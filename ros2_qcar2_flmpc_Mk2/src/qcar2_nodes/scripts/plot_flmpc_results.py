...
def plot_states(result_directory, states, reference_states):
    ...
    figure.tight_layout()
    figure.savefig(result_directory / "states_flmpc_Mk2.svg")
    plt.close(figure)
...
def plot_state_errors(result_directory, states, reference_states):
    ...
    figure.tight_layout()
    figure.savefig(result_directory / "states_error_flmpc_Mk2.svg")
    plt.close(figure)
...
def plot_controls(result_directory, controls, reference_states, reference_controls):
    ...
    figure.tight_layout()
    figure.savefig(result_directory / "controls_flmpc_Mk2.svg")
    plt.close(figure)
...
def plot_control_errors(result_directory, controls, reference_states, reference_controls):
    ...
    figure.tight_layout()
    figure.savefig(result_directory / "control_error_flmpc_Mk2.svg")
    plt.close(figure)
...
def plot_solve_times(result_directory, solve_times):
    ...
    figure.tight_layout()
    figure.savefig(result_directory / "solve_times_flmpc_Mk2.svg")
    plt.close(figure)
...
def plot_virtual_inputs(result_directory, virtual_inputs):
    ...
    figure.tight_layout()
    figure.savefig(result_directory / "virtual_inputs_flmpc_Mk2.svg")
    plt.close(figure)
...
def plot_trajectory(result_directory, states, reference_states):
    ...
    figure.tight_layout()
    figure.savefig(result_directory / "trajectory_tracking_flmpc_Mk2.svg")
    plt.close(figure)
...
def main():
    ...
    states = load_csv(result_directory, "states_flmpc_Mk2.csv")
    controls = load_csv(result_directory, "controls_flmpc_Mk2.csv")
    reference_states = load_csv(result_directory, "reference_used_flmpc_Mk2.csv")
    reference_controls = load_csv(result_directory, "reference_controls_flmpc_Mk2.csv")
    solve_times = load_csv(result_directory, "solve_times_flmpc_Mk2.csv")
    virtual_inputs = load_csv(result_directory, "virtual_inputs_flmpc_Mk2.csv")
