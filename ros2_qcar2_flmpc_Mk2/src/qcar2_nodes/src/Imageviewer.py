...
class ImageSubscriber(Node):
    # Initialize the image subscriber and selected ROS image topic.
    ...
    # Convert and display one compressed ROS image message.
    ...
    # Convert and display one uncompressed ROS image message.
    ...
    # Draw image information and display the current camera frame.
...
# Start the interactive image viewer ROS2 node.
def main(args=None):
