...
def parse_arguments():
    parser = argparse.ArgumentParser(description="Generate NMPC result plots from exported CSV files.")
    parser.add_argument("result_directory", type=Path, help="Directory containing one completed NMPC run.")
